 ...
 */
function doTClasses(it) { var out='<span>';var arr1=it.array;if(arr1){var value,index=-1,l1=arr1.length-1;while(index<l1){value=arr1[index+=1];out+='<p><span class="title">'+(value[0].title)+'</span> - ';var arr2=value[0].dates[value[1]];if(arr2){var value2,index2=-1,l2=arr2.length-1;while(index2<l2){value2=arr2[index2+=1];if(index2 > 0){out+=' & ';}out+=''+(value2);} } out+=' <span class="time">('+(value[0].times[value[1]])+')</span></p>';} } out+='</span>';return out; }
