 ...
 */
//function doTClasses(it) { var out='<span>';var arr1=it.array;if(arr1){var value,index=-1,l1=arr1.length-1;while(index<l1){value=arr1[index+=1];out+='<p>';if(value.image){out+='<img src='+(value.image)+' alt="">';}out+='<span class="title">'+(value.title)+'</span> - ';var arr2=value.date;if(arr2){var value2,index2=-1,l2=arr2.length-1;while(index2<l2){value2=arr2[index2+=1];if(index2 > 0){out+=' & ';}out+=''+(value2);} } out+='<span class="time">('+(value.time)+')</span></p>';} } out+='</span>';return out; }
...
*/
//function doTSummary(it) { var out='<article class="narrow"><h1>'+(it.title);if(it.parts > 1){out+=' - '+(it.parts)+' Parts';}out+=' <span>'+(it.cost)+'</span></h1><div class="classbox content clearfix"> ';if(it.image){out+='<img src='+(it.image)+' alt="">';}out+=' ';if(it.note){out+='<h3>Note: '+(it.note)+'</h3>';}out+=' <h4>Dates</h4> <p>';var arr1=it.dates;if(arr1){var value2,index2=-1,l1=arr1.length-1;while(index2<l1){value2=arr1[index2+=1];if(index2 > 0){out+=' OR ';}var arr2=value2;if(arr2){var value3,index3=-1,l2=arr2.length-1;while(index3<l2){value3=arr2[index3+=1];if(index3 > 0){out+=' & ';}out+=''+(value3);} } } } out+='</p> <h4>Times</h4> <p>';var arr3=it.times;if(arr3){var value2,index2=-1,l3=arr3.length-1;while(index2<l3){value2=arr3[index2+=1];if(index2 > 0){out+=' OR ';}out+=''+(value2);} } out+='</p> <h4>Description</h4> <p>'+(it.description)+'</p> <h4>Prerequisites</h4> <p>'+(it.prerequisites)+'</p> <h4>Supplies</h4> <p>'+(it.supplies)+'</p> </div> </article>';return out; }
function doTSummary(it) { var out='<article class="narrow"> ';if(it.link){out+='<a href="'+(it.link)+'>}}';}out+=' <h1>'+(it.title);if(it.parts > 1){out+=' - '+(it.parts)+' Parts';}out+=' <span>'+(it.cost)+'</span></h1> ';if(it.link){out+='</a>';}out+=' <div class="classbox content clearfix"> ';if(it.link){out+='<a href="'+(it.link)+'>}}';}if(it.image){out+='<img src='+(it.image)+' alt="">';}if(it.link){out+='</a>';}out+=' ';if(it.note){out+='<h3>Note: '+(it.note)+'</h3>';}out+=' <h4>Dates</h4> <p>';var arr1=it.dates;if(arr1){var value,index2=-1,l1=arr1.length-1;while(index2<l1){value=arr1[index2+=1];if(index2 > 0){out+=' OR ';}var arr2=value;if(arr2){var value,index3=-1,l2=arr2.length-1;while(index3<l2){value=arr2[index3+=1];if(index3 > 0){out+=' & ';}out+=''+(value);} } } } out+='</p> <h4>Times</h4> <p>';var arr3=it.times;if(arr3){var value,index2=-1,l3=arr3.length-1;while(index2<l3){value=arr3[index2+=1];if(index2 > 0){out+=' OR ';}out+=''+(value);} } out+='</p> <h4>Description</h4> <p>'+(it.description)+'</p> <h4>Prerequisites</h4> <p>'+(it.prerequisites)+'</p> <h4>Supplies</h4> <p>'+(it.supplies)+'</p> </div> </article>';return out; }
