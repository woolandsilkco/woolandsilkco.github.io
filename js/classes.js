 ...
 */
function doTSummary(it /**/) { var out='<div class="classbox"> <h2>'+(value.title);if(value.parts > 1){out+=' - '+(value.parts)+' Parts';}out+=' <span>'+(value.cost)+'</span></h2> ';if(value.note){out+='<h3>Note: '+(value.note)+'</h3>';}out+=' <h4>Dates</h4> <p>';var arr1=value.dates;if(arr1){var value2,index2=-1,l1=arr1.length-1;while(index2<l1){value2=arr1[index2+=1];if(index2 > 0){out+=', ';}out+=''+(value2);} } out+='</p> <h4>Times</h4> <p>';var arr2=value.times;if(arr2){var value2,index2=-1,l2=arr2.length-1;while(index2<l2){value2=arr2[index2+=1];if(index2 > 0){out+=' OR ';}out+=''+(value2);} } out+='</p> <h4>Description</h4> <p>'+(value.description)+'</p> <h4>Prerequisites</h4> <p>'+(value.prerequisites)+'</p> <h4>Supplies</h4> <p>'+(value.supplies)+'</p> <h4>Elements to Learn</h4> <ul> ';var arr3=value.elements;if(arr3){var value2,index2=-1,l3=arr3.length-1;while(index2<l3){value2=arr3[index2+=1];out+=' <li>'+(value2)+'</li> ';} } out+=' </ul></div>';return out; }
