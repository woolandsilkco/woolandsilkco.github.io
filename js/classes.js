 ...
 */
function doTSummary(it /**/) { var out='<div class="classbox"> <h2>'+(it.title);if(it.parts > 1){out+=' - '+(it.parts)+' Parts';}out+=' <span>'+(it.cost)+'</span></h2> ';if(it.note){out+='<h3>Note: '+(it.note)+'</h3>';}out+=' <h4>Dates</h4> <p>';var arr1=it.dates;if(arr1){var value,index2=-1,l1=arr1.length-1;while(index2<l1){value=arr1[index2+=1];if(index2 > 0){out+=', ';}out+=''+(value);} } out+='</p> <h4>Times</h4> <p>';var arr2=it.times;if(arr2){var value,index2=-1,l2=arr2.length-1;while(index2<l2){value=arr2[index2+=1];if(index2 > 0){out+=' OR ';}out+=''+(value);} } out+='</p> <h4>Description</h4> <p>'+(it.description)+'</p> <h4>Prerequisites</h4> <p>'+(it.prerequisites)+'</p> <h4>Supplies</h4> <p>'+(it.supplies)+'</p> <h4>Elements to Learn</h4> <ul> ';var arr3=it.elements;if(arr3){var value,index2=-1,l3=arr3.length-1;while(index2<l3){value=arr3[index2+=1];out+=' <li>'+(value)+'</li> ';} } out+=' </ul></div>';return out; }
