function doStuffWithClasses(data)
{
    ...
    var dotObject = { "array" : [ { "title":class1[0].title, "date":class1[0].dates[0], "content":class1[0].description },
                                  { "title":class2[0].title, "date":class2[0].dates[0], "content":class2[0].description } ]
                    };
